...
# - Train split SupCon/CE views use deterministic-seeded random aspect-preserving crops plus H/V flips; val/test remain deterministic letterbox + fixed Pi-camera magenta tint
