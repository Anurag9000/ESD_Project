...
- **Orchestration:** 8-stage pipeline: SupCon Head → SupCon Last-20 → SupCon Last-40 → CE Head → CE Last-20 → CE Last-40 → Recursive val_loss → Recursive val_raw_acc, with the same frozen 40-module core preserved through recursive refinement
