...
if __name__ == "__main__":
    # ======== HOW TO LOAD ========
    # Initialize with 10 classes (new taxonomy post-decontamination)
    # Classes: battery, clothes, ewaste, glass, hard_plastic, metal, organic, paper, shoes, soft_plastic
    model_10class = SmartBinModel(num_classes=10)
    ...
    try:
        ...
        model_10class.load_state_dict(checkpoint["model_state_dict"], strict=True)
        model_10class.eval()
        print("✅ Current 10-Class Model Loaded Perfectly!")
