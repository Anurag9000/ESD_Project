...
def run_turbo_jit_integration():
    parser = argparse.ArgumentParser(description="Generic Object Integrator")
    parser.add_argument("--dataset-root", default="Dataset_Final", help="Target dataset root")
    parser.add_argument("--ext-root", required=True, help="External datasets root to ingest from")
    parser.add_argument("--metadata-path", default="dataset_metadata.json", help="Metadata JSON path for deduplication")
    ...
    print(f"\n=== STARTING GENERIC JIT-PURGE INTEGRATOR ===")
