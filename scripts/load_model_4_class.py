...
if __name__ == "__main__":
    ...
    model_4class = SmartBinModel(num_classes=4)

    # Note: Update this path to where your old checkpoint actually is!
    checkpoint_path = "path/to/your/old_4class_model.pt"
    
    try:
        old_checkpoint = torch.load(checkpoint_path, map_location="cpu")
        model_4class.load_state_dict(old_checkpoint["model_state_dict"], strict=True)
        model_4class.eval()
        print("✅ Old 4-Class Model Loaded Perfectly!")
