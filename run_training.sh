...
SEED="${SEED:-42}"
ENABLE_PHASE0_MIM=0
PHASE0_MIM_EPOCHS="${PHASE0_MIM_EPOCHS:-20}"
PHASE0_MIM_BATCH_SIZE="${PHASE0_MIM_BATCH_SIZE:-240}"
PHASE0_MIM_ACCUM_STEPS="${PHASE0_MIM_ACCUM_STEPS:-1}"
...
for ARG in "$@"; do
  ...
  case "$ARG" in
    --phase0-mim)
      ENABLE_PHASE0_MIM=1
      ;;
    --phase0-mim-epochs|--phase0-mim-batch-size|--phase0-mim-accum-steps|--phase0-mim-mask-ratio|--phase0-mim-patch-size|--phase0-mim-decoder-dim|--phase0-mim-learning-rate|--phase0-mim-weight-decay)
      case "$ARG" in
