...
def predict_waste(image_path):
    ...
    print("Predicted class:", CLASSES[np.argmax(probs)], flush=True)
    ...
    if max_conf < CONFIDENCE_THRESHOLD:
        return "OTHER", conf_percent, original_guess
    else:
        return original_guess, conf_percent, original_guess

# ==============================
# 4. WEB INTERFACE (UNCHANGED)
# ==============================
HTML_PAGE = """
<!doctype html>
<html>
