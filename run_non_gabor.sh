...
RUN_ROOT="${RUN_ROOT:-Results/efficientnet_b0_non_gabor_all_classes_${RUN_STAMP}}"
LOG_ROOT="${LOG_ROOT:-logs/efficientnet_b0_non_gabor_all_classes_${RUN_STAMP}}"
...
./run_non_gabor_full_model_loss_then_rawacc_recursive.sh "${FILTERED_ARGS[@]}"
